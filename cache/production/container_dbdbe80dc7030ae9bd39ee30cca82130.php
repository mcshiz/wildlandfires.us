...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007ce1889d000000005a7d34c2(
...
class phpbbtemplatetwiglexer_000000007ce1889d000000005a7d34c2 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a30885c530c2761989400 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a30885c530cb379396780 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a30885c53092310669025 = array(
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, 'set_environment', array('env' => $env), $this->initializer5a30885c530cb379396780);

        return $this->valueHolder5a30885c530c2761989400->set_environment($env);
    }
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a30885c530cb379396780);

        return $this->valueHolder5a30885c530c2761989400->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a30885c530cb379396780);

        return $this->valueHolder5a30885c530c2761989400->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a30885c530cb379396780 = $initializer;
    }
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, '__get', array('name' => $name), $this->initializer5a30885c530cb379396780);

        if (isset(self::$publicProperties5a30885c53092310669025[$name])) {
            return $this->valueHolder5a30885c530c2761989400->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a30885c530c2761989400;
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a30885c530cb379396780);
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, '__isset', array('name' => $name), $this->initializer5a30885c530cb379396780);
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, '__unset', array('name' => $name), $this->initializer5a30885c530cb379396780);
    ...
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, '__clone', array(), $this->initializer5a30885c530cb379396780);

        $this->valueHolder5a30885c530c2761989400 = clone $this->valueHolder5a30885c530c2761989400;
    }

    public function __sleep()
    {
        $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, '__sleep', array(), $this->initializer5a30885c530cb379396780);

        return array('valueHolder5a30885c530c2761989400');
    }
    ...
    {
        return $this->initializer5a30885c530cb379396780;
    }
    ...
    {
        return $this->initializer5a30885c530cb379396780 && $this->initializer5a30885c530cb379396780->__invoke($this->valueHolder5a30885c530c2761989400, $this, 'initializeProxy', array(), $this->initializer5a30885c530cb379396780);
    }
    ...
    {
        return null !== $this->valueHolder5a30885c530c2761989400;
    }
    ...
    {
        return $this->valueHolder5a30885c530c2761989400;
    }
