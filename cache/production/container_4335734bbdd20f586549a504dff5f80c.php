...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'dmzx.formcreator.admin.controller' => 'getDmzx_Formcreator_Admin_ControllerService',
            'dmzx.formcreator.listener' => 'getDmzx_Formcreator_ListenerService',
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('dmzx.formcreator.listener', 'dmzx\\formcreator\\event\\listener');
    ...
    /**
     * Gets the 'dmzx.formcreator.admin.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\formcreator\controller\admin_controller A dmzx\formcreator\controller\admin_controller instance
     */
    protected function getDmzx_Formcreator_Admin_ControllerService()
    {
        return $this->services['dmzx.formcreator.admin.controller'] = new \dmzx\formcreator\controller\admin_controller($this->get('user'), $this->get('template'), $this->get('dbal.conn'), $this->get('request'), './', 'php', 'phpbb_form_maker');
    }

    /**
     * Gets the 'dmzx.formcreator.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\formcreator\event\listener A dmzx\formcreator\event\listener instance
     */
    protected function getDmzx_Formcreator_ListenerService()
    {
        return $this->services['dmzx.formcreator.listener'] = new \dmzx\formcreator\event\listener($this->get('user'), $this->get('template'), $this->get('dbal.conn'), $this->get('config'), $this->get('auth'), $this->get('controller.helper'), $this->get('cache'), $this->get('request'), './', 'php', 'phpbb_form_maker', $this->get('files.factory', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'phpbb.mediaembed.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\mediaembed\event\main_listener A phpbb\mediaembed\event\main_listener instance
     */
    ...
    /**
     * Gets the 'phpbb.pages.cron.task.text_reparser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    /**
     * Gets the 'phpbb.pages.routing.loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\pages\routing\page_loader A phpbb\pages\routing\page_loader instance
     */
    ...
    /**
     * Gets the 'phpbb.pages.text_reparser.page_text' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\pages\textreparser\plugins\pages_text A phpbb\pages\textreparser\plugins\pages_text instance
     */
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004347251d000000001e45fdec(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dmzx.formcreator.table.formcreator' => 'phpbb_form_maker',
...
class phpbbtemplatetwiglexer_000000004347251d000000001e45fdec extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a30884d18438703581710 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a30884d18448994194907 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a30884d183fa275448788 = array(
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, 'set_environment', array('env' => $env), $this->initializer5a30884d18448994194907);

        return $this->valueHolder5a30884d18438703581710->set_environment($env);
    }
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a30884d18448994194907);

        return $this->valueHolder5a30884d18438703581710->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a30884d18448994194907);

        return $this->valueHolder5a30884d18438703581710->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a30884d18448994194907 = $initializer;
    }
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, '__get', array('name' => $name), $this->initializer5a30884d18448994194907);

        if (isset(self::$publicProperties5a30884d183fa275448788[$name])) {
            return $this->valueHolder5a30884d18438703581710->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a30884d18438703581710;
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a30884d18448994194907);
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, '__isset', array('name' => $name), $this->initializer5a30884d18448994194907);
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, '__unset', array('name' => $name), $this->initializer5a30884d18448994194907);
    ...
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, '__clone', array(), $this->initializer5a30884d18448994194907);

        $this->valueHolder5a30884d18438703581710 = clone $this->valueHolder5a30884d18438703581710;
    }

    public function __sleep()
    {
        $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, '__sleep', array(), $this->initializer5a30884d18448994194907);

        return array('valueHolder5a30884d18438703581710');
    }
    ...
    {
        return $this->initializer5a30884d18448994194907;
    }
    ...
    {
        return $this->initializer5a30884d18448994194907 && $this->initializer5a30884d18448994194907->__invoke($this->valueHolder5a30884d18438703581710, $this, 'initializeProxy', array(), $this->initializer5a30884d18448994194907);
    }
    ...
    {
        return null !== $this->valueHolder5a30884d18438703581710;
    }
    ...
    {
        return $this->valueHolder5a30884d18438703581710;
    }
